          ...
          <div className="flex-1 xl:ml-24 text-center md:text-left mb-12 md:mb-0 ">
            <div className="max-w-[520px] mx-auto order-2 xl:order-none">
              ...
              <motion.p
                ...
                className="mb-10"
              >
                Our Web Hosting is perfect for individuals and businesses
                looking to host their online presence on a high-speed cloud.
                Powered by Solid State Drives protected by Raid 10.
              </motion.p>
